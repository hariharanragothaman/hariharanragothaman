...
15. **Unified DevSecOps Pipelines - Accelerating Secure Deployments with NLP and JFrog XRAY** — SwampUp 2025, Napa Valley, California, USA (Sep 2025)
14. [**Shift-Left Meets Zero Trust - Building Secure-by-Design APIs from Day Zero**](https://www.youtube.com/watch?v=m4SDfJPQHQ8) — Secure Software by Design 2025, Carnegie Mellon University, USA (Aug 2025)
13. **Async Python for Data Science - Speeding Up IO-Bound Workflows** — Elastic & PyData Joint Meetup, NYC, USA (Aug 2025)
12. [**From Robotics to DevSecOps - A Journey in Tech**](https://www.youtube.com/watch?v=tlRdrqWABQk) — TestGuild DevOps Tools Podcast (Jul 2025)
11. **Zero Trust at the API Layer - Strategies for Securing Microservices in Multi-Cloud Environments** — Zero Trust Working Group, Cloud Security Alliance (Jun 2025)
10. [**Secure-by-Design AI Agents - Open-Source Workflows for DevSecOps Automation**](https://www.youtube.com/watch?v=FONwzUIMB7M) — ACM Austin Kickoff Lightning Talks, Austin, TX, USA (Jun 2025)
9. **Building Resilience - Revolutionizing Application Security with Unified Deployments and Automated SBOM** — AMD DevOps World Conference 2025, Austin, TX, USA (May 2025)
8. [**Uncovering 100K Security Violations - Strengthening Application Security through Unified Deployments, XRAY Integration and Automated SBOM Generation**](https://www.youtube.com/watch?v=Edky-9GsZOk) — OWASP Foundation, Boston Application Security Conference 2025, Boston, MA, USA (Apr 2025)
7. **Advancing Healthcare Security with DevSecOps - Initiatives and Industry Insights** — IEEE Orange County Computer Society (OCCS) Global Emerging Technologies Series, CA, USA (Feb 2025)
6. [**C++ and Python - Building Robust Applications by Offloading Compute-Heavy Workloads**](https://www.youtube.com/watch?v=DlQQCvHFiho) — Conf42 Python 2025 (Feb 2025)
5. [**Securely Unifying Deployments in an Organization for Increased Governance**](https://www.youtube.com/watch?v=8DrgMFgzJlY) — Conf42 DevOps 2025 (Jan 2025)
4. **DevSecOps in Action - Building Resilient and Secure Distributed Systems** — IEEE ARIAA 2024 (Dec 2024)
3. **Artificial Intelligence Driven Automation in DevOps - Transforming Security and Resilience** — ICMR 2024 (Dec 2024)
2. **Improving Code Quality through Continuous Integration Testing** — Bose Technical Conference (BTC-2017), Framingham, MA, USA (Nov 2017)
